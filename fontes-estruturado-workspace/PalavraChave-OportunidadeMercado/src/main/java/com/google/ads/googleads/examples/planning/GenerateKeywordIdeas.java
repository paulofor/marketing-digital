...
public class GenerateKeywordIdeas {
  ...
  public static void main(String[] args) throws IOException {
    ...
    if (!params.parseArguments(args)) {
      ...
      */
      params.locationIds = Arrays.asList();
      params.languageId = Constantes.LINGUA_PORTUGUES;
      params.keywords = Arrays.asList("como aprender");
  ...
  private void runExample(
    ...
    try (KeywordPlanIdeaServiceClient keywordPlanServiceClient =
      ...
      if (keywords.isEmpty()) {
        ...
        //requestBuilder.getKeywordSeedBuilder().addKeywords("maquiagem");
    	  requestBuilder.getKeywordSeedBuilder().addKeywords("montar uma");
      } else {
      ...
      for (GenerateKeywordIdeaResult result : response.iterateAll()) {
    	  ...
    	  if (result.getKeywordIdeaMetrics().getAvgMonthlySearches()>100) {
    		  System.out.println("Valor CPC: " + result.getKeywordIdeaMetrics().getHighTopOfPageBidMicros() / 1000000D);
    		  System.out.printf(
