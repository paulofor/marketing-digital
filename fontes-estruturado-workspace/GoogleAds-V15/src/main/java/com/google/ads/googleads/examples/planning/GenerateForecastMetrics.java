...
import com.google.ads.googleads.v15.services.BiddableKeyword;
import com.google.ads.googleads.v15.services.CampaignToForecast;
import com.google.ads.googleads.v15.services.CampaignToForecast.CampaignBiddingStrategy;
...
import com.google.ads.googleads.v15.services.KeywordForecastMetrics;
...
public class GenerateForecastMetrics {
  ...
  private void runExample(GoogleAdsClient googleAdsClient, Long customerId) {
    ...
    try (KeywordPlanIdeaServiceClient keywordPlanIdeaServiceClient =
      ...
      System.out.printf(
              "Taxa Conversão: %s%n", metrics.hasConversionRate() ? metrics.getConversionRate() : null);
      System.out.printf(
              "Qtde Conversão: %s%n", metrics.hasConversions() ? metrics.getConversions() : null);
      System.out.printf(
