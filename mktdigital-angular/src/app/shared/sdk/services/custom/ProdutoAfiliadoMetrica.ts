 ...
 */
@Injectable()
export class ProdutoAfiliadoMetricaApi extends BaseLoopBackApi {
   ...
   * </em>
   */
  public CalculaAtual(customHeaders?: Function): Observable<any> {
   ...
   * </em>
   */
  public ObtemItensLucro(customHeaders?: Function): Observable<any> {
    let _method: string = "GET";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
