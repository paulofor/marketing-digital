...
/**
 * Api services for the `AnuncioCampanhaTesteAds` model.
 */
@Injectable()
export class AnuncioCampanhaTesteAdsApi extends BaseLoopBackApi {
   ...
   *
   * @param {any} id AnuncioCampanhaTesteAds id
   *
   ...
   * This usually means the response is a `AnuncioCampanhaTesteAds` object.)
   * </em>
   */
  public getAnuncioAds(id: any, refresh: any = {}, customHeaders?: Function): Observable<any> {
    let _method: string = "GET";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/AnuncioCampanhaTesteAds/:id/anuncioAds";
