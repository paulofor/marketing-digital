 ...
 */
@Injectable()
export class AnuncioCampanhaAdsTesteApi extends BaseLoopBackApi {
   ...
   * </em>
   */
  public AtualizaPorCampanhaAdsTeste(campanhaAdsTesteId: any = {}, listaAnuncio: any = {}, customHeaders?: Function): Observable<any> {
    ...
    if (typeof listaAnuncio !== 'undefined' && listaAnuncio !== null) _urlParams.listaAnuncio = listaAnuncio;
    let result = this.request(_method, _url, _routeParams, _urlParams, _postBody, null, customHeaders);
    return result;
  }
