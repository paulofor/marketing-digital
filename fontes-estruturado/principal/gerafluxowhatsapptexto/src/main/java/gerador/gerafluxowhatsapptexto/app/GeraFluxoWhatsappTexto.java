package gerador.gerafluxowhatsapptexto.app;
...
public class GeraFluxoWhatsappTexto {

	private static String UrlLoopback = "";

	public static void main(String[] args) {
		System.out.print("GeraFluxoWhatsappTexto");
		System.out.println("(13/11/2024 12:10:44)");
		try {
			carregaProp();
	...
	private static void gravarErro(Exception e) {
		try {
			FileWriter fileWriter = new FileWriter("GeraFluxoWhatsappTexto.err", true);
