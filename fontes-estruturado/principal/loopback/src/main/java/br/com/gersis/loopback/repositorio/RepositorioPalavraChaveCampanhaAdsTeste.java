...
public class RepositorioPalavraChaveCampanhaAdsTeste extends ModelRepository<PalavraChaveCampanhaAdsTeste> {

	public RepositorioPalavraChaveCampanhaAdsTeste() {
		super("PalavraChaveCampanhaAdsTeste", PalavraChaveCampanhaAdsTeste.class);
	}
	@Override
