...
public class WhatsappMensagem extends Model {
	...
	public JSONObject getJSON() {
		...
		try {
			obj.put("id",getId());
			obj.put("texto", texto);
			obj.put("dataHoraEnvio", dataHoraEnvio);
			obj.put("situacao", situacao);
		} catch (Exception e) {
			e.printStackTrace();
		}
		return obj;
	...
	public void setDataHoraEnvio(String valor) { 
		this.dataHoraEnvio = valor;
	}
	public String getDataHoraEnvio() { 
		return this.dataHoraEnvio;
	}
	public void setSituacao(int valor) { 
		this.situacao = valor;
	}
