...
public abstract class RespostaPublicoAlvo_AtualizaUltimaRespostaProduto extends DaoAplicacao { 
	...
	protected final void executaImpl() {
		...
		if (executaCustom(ds.getProdutoProprioCorrente())) {
			repRespostaPublicoAlvo.atualizaUltimaRespostaProduto( idProduto, new VoidCallback() { 
