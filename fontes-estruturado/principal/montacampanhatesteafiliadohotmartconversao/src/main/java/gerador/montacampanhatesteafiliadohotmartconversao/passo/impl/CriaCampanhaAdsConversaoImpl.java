...
import gerador.montacampanhatesteafiliadohotmartconversao.passo.CriaCampanhaAdsConversao;


public class CriaCampanhaAdsConversaoImpl extends CriaCampanhaAdsConversao { 
	...
	//private static Long CODIGO_USUARIO = 7966834741L;
		...
		protected boolean executaCustom(CampanhaAdsTeste campanhaTesteCorrente) {
			...
			try {
				...
				String resourceNameCampanha = criaCampanha(googleAdsClient, budgetResourceName, codigoUsuario, campanhaTesteCorrente);
		...
		private String criaCampanha(GoogleAdsClient googleAdsClient, String orcamento, long customerId,  CampanhaAdsTeste campanha) {
		...
		private String criaCampanha2(GoogleAdsClient googleAdsClient, long customerId, String budgetResourceName, CampanhaAdsTeste campanha) {
