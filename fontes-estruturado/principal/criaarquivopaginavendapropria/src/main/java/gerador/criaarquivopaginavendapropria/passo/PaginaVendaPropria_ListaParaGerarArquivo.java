...
public abstract class PaginaVendaPropria_ListaParaGerarArquivo extends DaoAplicacao { 
	...
	protected final void executaImpl() {
		...
		if (executaCustom()) {
			repPaginaVendaPropria.listaParaGerarArquivo(  new ListCallback<PaginaVendaPropria>() { 
				public void onSuccess(List<PaginaVendaPropria> lista) {
					for (PaginaVendaPropria item : lista) {
						ds.setPaginaVendaCorrente(item);
