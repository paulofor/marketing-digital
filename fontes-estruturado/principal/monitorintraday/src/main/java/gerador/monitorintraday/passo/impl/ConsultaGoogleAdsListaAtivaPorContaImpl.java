...
public class ConsultaGoogleAdsListaAtivaPorContaImpl extends ConsultaGoogleAdsListaAtivaPorConta { 
	...
	protected boolean executaCustom(ContaGoogle contaCorrente) {
		...
		String propertiesFilePath = "ads.properties"; // Nome do arquivo de propriedades

		File propertiesFile = new File(propertiesFilePath);
		System.out.println("Procurando o arquivo de propriedades em: " + propertiesFile.getAbsolutePath());
