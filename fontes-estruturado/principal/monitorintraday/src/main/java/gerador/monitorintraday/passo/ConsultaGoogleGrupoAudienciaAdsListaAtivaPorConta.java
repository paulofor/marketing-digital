...
public abstract class ConsultaGoogleGrupoAudienciaAdsListaAtivaPorConta extends DaoAplicacao { 
	...
	protected final DaoBase getProximo() {
		return new ConsultaGoogleGrupoLocaisAdsListaAtivaPorContaImpl();
	}
