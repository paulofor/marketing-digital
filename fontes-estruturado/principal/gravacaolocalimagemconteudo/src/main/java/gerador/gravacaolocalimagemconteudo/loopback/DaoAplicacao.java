...
public abstract class DaoAplicacao extends DaoBase {
	...
	protected RepositorioFrameworkPublicoCategoria repFrameworkPublicoCategoria = adapter.createRepository(RepositorioFrameworkPublicoCategoria.class);
	protected RepositorioFrameworkPublicoInteresse repFrameworkPublicoInteresse = adapter.createRepository(RepositorioFrameworkPublicoInteresse.class);
	protected RepositorioBusinessManager repBusinessManager = adapter.createRepository(RepositorioBusinessManager.class);
	protected RepositorioContaNegocioFacebook repContaNegocioFacebook = adapter.createRepository(RepositorioContaNegocioFacebook.class);
	protected RepositorioContaBm repContaBm = adapter.createRepository(RepositorioContaBm.class);
	protected RepositorioMetaAdsPublico repMetaAdsPublico = adapter.createRepository(RepositorioMetaAdsPublico.class);
	protected RepositorioPublicoInteresse repPublicoInteresse = adapter.createRepository(RepositorioPublicoInteresse.class);
	protected RepositorioPaginaVendaAbertaSecao repPaginaVendaAbertaSecao = adapter.createRepository(RepositorioPaginaVendaAbertaSecao.class);
	protected RepositorioEntregavelCapitulo repEntregavelCapitulo = adapter.createRepository(RepositorioEntregavelCapitulo.class);
	protected RepositorioEntregavelCapituloDetalhe repEntregavelCapituloDetalhe = adapter.createRepository(RepositorioEntregavelCapituloDetalhe.class);
	protected RepositorioElementoPaginaCheckout repElementoPaginaCheckout = adapter.createRepository(RepositorioElementoPaginaCheckout.class);
	protected RepositorioPerguntaPublicoAlvo repPerguntaPublicoAlvo = adapter.createRepository(RepositorioPerguntaPublicoAlvo.class);
	protected RepositorioRespostaPublicoAlvo repRespostaPublicoAlvo = adapter.createRepository(RepositorioRespostaPublicoAlvo.class);
	protected RepositorioMercadoPotencial repMercadoPotencial = adapter.createRepository(RepositorioMercadoPotencial.class);
	protected RepositorioCheckoutSecao repCheckoutSecao = adapter.createRepository(RepositorioCheckoutSecao.class);
	protected RepositorioCheckoutSecaoProduto repCheckoutSecaoProduto = adapter.createRepository(RepositorioCheckoutSecaoProduto.class);
	protected RepositorioElementoCheckoutProduto repElementoCheckoutProduto = adapter.createRepository(RepositorioElementoCheckoutProduto.class);
	...
	protected void enviaParaServidor(String fonte, String destino) throws Exception {
		...
		JSch jsch = new JSch();
		Session session = jsch.getSession("root", "191.252.92.222", 22);
