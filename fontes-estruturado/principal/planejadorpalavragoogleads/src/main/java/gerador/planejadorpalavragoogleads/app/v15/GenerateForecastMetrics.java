...
package gerador.planejadorpalavragoogleads.app.v15;
...
public class GenerateForecastMetrics {
  ...
  public static void main(String[] args) {
    ...
    try {
      new GenerateForecastMetrics().runExample(googleAdsClient, customerId);
  ...
  private void runExample(GoogleAdsClient googleAdsClient, Long customerId) {
    ...
    try (KeywordPlanIdeaServiceClient keywordPlanIdeaServiceClient =
        googleAdsClient.getVersion15().createKeywordPlanIdeaServiceClient()) {
