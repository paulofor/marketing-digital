...
export class ContaWhatsappListBaseComponent implements OnInit {
	principal: ContaWhatsapp;
	listaBase:ContaWhatsapp[]
	idPrincipal: number;
    ...
    carregaTela() {
        this.srv.find(this.getFiltro())
	     .subscribe((result:ContaWhatsapp[]) => {
	...
	getComponente() : any {
		return ContaWhatsappEditComponent
	}
