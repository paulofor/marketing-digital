...
import { ItemConteudoProduto, ItemConteudoProdutoApi } from "../shared/sdk";

export class ItemConteudoProdutoEditBaseComponent implements OnInit{

	itemPre: any;
	item: ItemConteudoProduto;
	origem: any;
	...
	criaItem() {
   		return new ItemConteudoProduto();
	}
	montaCombos() {
	}
	posItem() {
