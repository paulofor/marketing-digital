...
import { AnuncioAdsDisplay, AnuncioAdsDisplayApi } from "../shared/sdk";

export class AnuncioAdsDisplayEditBaseComponent implements OnInit{

	itemPre: any;
	item: AnuncioAdsDisplay;
	origem: any;
