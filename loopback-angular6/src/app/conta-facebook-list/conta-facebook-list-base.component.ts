...
export class ContaFacebookListBaseComponent implements OnInit {
	principal: ContaFacebook;
	listaBase:ContaFacebook[]
	idPrincipal: number;
    ...
    carregaTela() {
        this.srv.find(this.getFiltro())
	     .subscribe((result:ContaFacebook[]) => {
	...
	getComponente() : any {
		return ContaFacebookEditComponent
	}
