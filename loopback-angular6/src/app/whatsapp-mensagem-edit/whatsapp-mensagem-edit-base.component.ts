...
import { WhatsappMensagem, WhatsappMensagemApi } from "../shared/sdk";

export class WhatsappMensagemEditBaseComponent implements OnInit{

	itemPre: any;
	item: WhatsappMensagem;
	origem: any;
