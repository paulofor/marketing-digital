...
export class BusinessManagerListBaseComponent implements OnInit {
	principal: BusinessManager;
	listaBase:BusinessManager[]
	idPrincipal: number;
    ...
    carregaTela() {
        this.srv.find(this.getFiltro())
	     .subscribe((result:BusinessManager[]) => {
	...
	getComponente() : any {
		return BusinessManagerEditComponent
	}
