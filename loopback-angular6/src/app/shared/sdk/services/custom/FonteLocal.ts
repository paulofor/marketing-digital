...
/**
 * Api services for the `FonteLocal` model.
 */
@Injectable()
export class FonteLocalApi extends BaseLoopBackApi {
  ...
  public findByIdImagemConjuntos(id: any, fk: any, customHeaders?: Function): Observable<any> {
    let _method: string = "GET";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/FonteLocals/:id/imagemConjuntos/:fk";
    let _routeParams: any = {
      id: id,
      fk: fk
    };
  ...
  /**
   * criativoAnuncios consultas de FonteLocal.
   *
   * @param {any} id FonteLocal id
   *
   * @param {object} filter 
  ...
  public getCriativoAnuncios(id: any, filter: LoopBackFilter = {}, customHeaders?: Function): Observable<any> {
    let _method: string = "GET";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/FonteLocals/:id/criativoAnuncios";
    let _routeParams: any = {
      id: id
    };
    let _postBody: any = {};
  ...
  /**
   * criativoAnuncios contagens de FonteLocal.
   *
   * @param {any} id FonteLocal id
   *
  ...
  public countCriativoAnuncios(id: any, where: any = {}, customHeaders?: Function): Observable<any> {
    let _method: string = "GET";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/FonteLocals/:id/criativoAnuncios/count";
    let _routeParams: any = {
      id: id
    };
    let _postBody: any = {};
  ...
  /**
   * imagemConjuntos consultas de FonteLocal.
   *
   * @param {any} id FonteLocal id
   *
   * @param {object} filter 
  ...
  public getImagemConjuntos(id: any, filter: LoopBackFilter = {}, customHeaders?: Function): Observable<any> {
    let _method: string = "GET";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/FonteLocals/:id/imagemConjuntos";
    let _routeParams: any = {
      id: id
    };
    let _postBody: any = {};
  ...
  /**
   * imagemConjuntos contagens de FonteLocal.
   *
   * @param {any} id FonteLocal id
   *
   * @param {object} where Criteria to match model instances
  ...
  public countImagemConjuntos(id: any, where: any = {}, customHeaders?: Function): Observable<any> {
    let _method: string = "GET";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/FonteLocals/:id/imagemConjuntos/count";
    let _routeParams: any = {
      id: id
    };
    let _postBody: any = {};
