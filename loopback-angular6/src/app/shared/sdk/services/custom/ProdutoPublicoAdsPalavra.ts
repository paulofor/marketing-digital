...
/**
 * Api services for the `ProdutoPublicoAdsPalavra` model.
 */
@Injectable()
export class ProdutoPublicoAdsPalavraApi extends BaseLoopBackApi {
   ...
   *
   * @param {any} id ProdutoPublicoAdsPalavra id
   *
   ...
   * This usually means the response is a `ProdutoPublicoAdsPalavra` object.)
   * </em>
   */
  public getProdutoAfiliadoHotmart(id: any, refresh: any = {}, customHeaders?: Function): Observable<any> {
    let _method: string = "GET";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/ProdutoPublicoAdsPalavras/:id/produtoAfiliadoHotmart";
  ...
  public getPublicoAlvoAdsPalavra(id: any, refresh: any = {}, customHeaders?: Function): Observable<any> {
    let _method: string = "GET";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/ProdutoPublicoAdsPalavras/:id/publicoAlvoAdsPalavra";
    let _routeParams: any = {
      id: id
    };
    let _postBody: any = {};
