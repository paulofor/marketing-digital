...
/**
 * Api services for the `LoadPaginaVendaPropria` model.
 */
@Injectable()
export class LoadPaginaVendaPropriaApi extends BaseLoopBackApi {
   ...
   *
   * @param {any} id LoadPaginaVendaPropria id
   *
  ...
  public getPaginaVendaPropria(id: any, refresh: any = {}, customHeaders?: Function): Observable<any> {
    ...
    "/LoadPaginaVendaPropria/:id/paginaVendaPropria";
