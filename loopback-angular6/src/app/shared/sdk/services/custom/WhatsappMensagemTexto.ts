...
/**
 * Api services for the `WhatsappMensagemTexto` model.
 */
@Injectable()
export class WhatsappMensagemTextoApi extends BaseLoopBackApi {
  ...
  /**
   * Busca relação whatsappGrupoPadraoMensagem de belongsTo.
   *
   * @param {any} id WhatsappMensagemTexto id
   *
   ...
   * </em>
   */
  public getWhatsappGrupoPadraoMensagem(id: any, refresh: any = {}, customHeaders?: Function): Observable<any> {
    let _method: string = "GET";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/WhatsappMensagemTextos/:id/whatsappGrupoPadraoMensagem";
  ...
  /**
   * Busca relação whatsappGrupoDiaAgenda de belongsTo.
   *
   * @param {any} id WhatsappMensagemTexto id
   *
   * @param {boolean} refresh 
   ...
   * </em>
   */
  public getWhatsappGrupoDiaAgenda(id: any, refresh: any = {}, customHeaders?: Function): Observable<any> {
    let _method: string = "GET";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/WhatsappMensagemTextos/:id/whatsappGrupoDiaAgenda";
    let _routeParams: any = {
      id: id
    };
    let _postBody: any = {};
  ...
  /**
   * Busca relação whatsappModeloMensagem de belongsTo.
   *
   * @param {any} id WhatsappMensagemTexto id
   *
   * @param {boolean} refresh 
   ...
   * </em>
   */
  public getWhatsappModeloMensagem(id: any, refresh: any = {}, customHeaders?: Function): Observable<any> {
    let _method: string = "GET";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/WhatsappMensagemTextos/:id/whatsappModeloMensagem";
    let _routeParams: any = {
      id: id
    };
    let _postBody: any = {};
