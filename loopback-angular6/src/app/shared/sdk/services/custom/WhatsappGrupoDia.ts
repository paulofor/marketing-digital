...
/**
 * Api services for the `WhatsappGrupoDia` model.
 */
@Injectable()
export class WhatsappGrupoDiaApi extends BaseLoopBackApi {
   ...
   *
   * @param {any} id WhatsappGrupoDia id
   *
