 ...
 */
@Injectable()
export class PixelGoogleApi extends BaseLoopBackApi {
  ...
  public findByIdPublicoAlvoAdsDiarios(id: any, fk: any, customHeaders?: Function): Observable<any> {
    let _method: string = "GET";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/PixelGoogles/:id/publicoAlvoAdsDiarios/:fk";
    let _routeParams: any = {
      id: id,
      fk: fk
    };
  ...
  /**
   * publicoAlvoAdsDiarios consultas de PixelGoogle.
   *
   * @param {any} id PixelGoogle id
   *
   * @param {object} filter 
  ...
  public getPublicoAlvoAdsDiarios(id: any, filter: LoopBackFilter = {}, customHeaders?: Function): Observable<any> {
    let _method: string = "GET";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/PixelGoogles/:id/publicoAlvoAdsDiarios";
    let _routeParams: any = {
      id: id
    };
    let _postBody: any = {};
  ...
  /**
   * publicoAlvoAdsDiarios contagens de PixelGoogle.
   *
   * @param {any} id PixelGoogle id
   *
   * @param {object} where Criteria to match model instances
  ...
  public countPublicoAlvoAdsDiarios(id: any, where: any = {}, customHeaders?: Function): Observable<any> {
    let _method: string = "GET";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/PixelGoogles/:id/publicoAlvoAdsDiarios/count";
    let _routeParams: any = {
      id: id
    };
    let _postBody: any = {};
   ...
   * </em>
   */
  public ListaParaAjusteComConta(customHeaders?: Function): Observable<any> {
    let _method: string = "GET";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/PixelGoogles/listaParaAjusteComConta";
    let _routeParams: any = {};
    let _postBody: any = {};
    let _urlParams: any = {};
    let result = this.request(_method, _url, _routeParams, _urlParams, _postBody, null, customHeaders);
   ...
   * </em>
   */
  public AtualizaAjuste(pixel: any = {}, customHeaders?: Function): Observable<any> {
    let _method: string = "POST";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/PixelGoogles/atualizaAjuste";
    let _routeParams: any = {};
    let _postBody: any = {};
    let _urlParams: any = {};
    if (typeof pixel !== 'undefined' && pixel !== null) _urlParams.pixel = pixel;
    let result = this.request(_method, _url, _routeParams, _urlParams, _postBody, null, customHeaders);
    return result;
  }
