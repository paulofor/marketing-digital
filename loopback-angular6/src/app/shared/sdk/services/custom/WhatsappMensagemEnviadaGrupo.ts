...
/**
 * Api services for the `WhatsappMensagemEnviadaGrupo` model.
 */
@Injectable()
export class WhatsappMensagemEnviadaGrupoApi extends BaseLoopBackApi {
   ...
   *
   * @param {any} id WhatsappMensagemEnviadaGrupo id
   *
   ...
   * This usually means the response is a `WhatsappMensagemEnviadaGrupo` object.)
   * </em>
   */
  public getWhatsappGrupo(id: any, refresh: any = {}, customHeaders?: Function): Observable<any> {
    let _method: string = "GET";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/WhatsappMensagemEnviadaGrupos/:id/whatsappGrupo";
  ...
  public patchAttributes(id: any, data: any = {}, customHeaders?: Function): Observable<any> {
    let _method: string = "PATCH";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/WhatsappMensagemEnviadaGrupos/:id";
    let _routeParams: any = {
      id: id
    };
    let _postBody: any = {
