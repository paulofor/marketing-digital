...
export class PalavraChaveEstatisticaApi extends BaseLoopBackApi {
  ...
  /**
   * Busca relação palavraChaveGoogle de belongsTo.
   *
  ...
  /**
   * Busca relação palavraChaveRaiz de belongsTo.
   *
   * @param {any} id PalavraChaveEstatistica id
   *
   * @param {boolean} refresh 
   ...
   * </em>
   */
  public InsereLista(listaPalavra: any = {}, palavraChaveRaizId: any = {}, customHeaders?: Function): Observable<any> {
    ...
    if (typeof palavraChaveRaizId !== 'undefined' && palavraChaveRaizId !== null) _urlParams.palavraChaveRaizId = palavraChaveRaizId;
    let result = this.request(_method, _url, _routeParams, _urlParams, _postBody, null, customHeaders);
    return result;
  }
