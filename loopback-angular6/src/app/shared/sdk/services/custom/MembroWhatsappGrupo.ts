...
/**
 * Api services for the `MembroWhatsappGrupo` model.
 */
@Injectable()
export class MembroWhatsappGrupoApi extends BaseLoopBackApi {
   ...
   *
   * @param {any} id MembroWhatsappGrupo id
   *
   ...
   * This usually means the response is a `MembroWhatsappGrupo` object.)
   * </em>
   */
  public getWhatsappGrupo(id: any, refresh: any = {}, customHeaders?: Function): Observable<any> {
    let _method: string = "GET";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/MembroWhatsappGrupos/:id/whatsappGrupo";
