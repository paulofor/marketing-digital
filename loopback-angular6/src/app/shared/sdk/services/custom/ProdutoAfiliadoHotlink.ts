 ...
 */
@Injectable()
export class ProdutoAfiliadoHotlinkApi extends BaseLoopBackApi {
  ...
  public findByIdPaginaVendas(id: any, fk: any, customHeaders?: Function): Observable<any> {
    let _method: string = "GET";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/ProdutoAfiliadoHotlinks/:id/paginaVendas/:fk";
    let _routeParams: any = {
      id: id,
      fk: fk
    };
  ...
  /**
   * paginaVendas consultas de ProdutoAfiliadoHotlink.
   *
   * @param {any} id ProdutoAfiliadoHotlink id
   *
   * @param {object} filter 
  ...
  public getPaginaVendas(id: any, filter: LoopBackFilter = {}, customHeaders?: Function): Observable<any> {
    let _method: string = "GET";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/ProdutoAfiliadoHotlinks/:id/paginaVendas";
    let _routeParams: any = {
      id: id
    };
    let _postBody: any = {};
  ...
  /**
   * paginaVendas contagens de ProdutoAfiliadoHotlink.
   *
   * @param {any} id ProdutoAfiliadoHotlink id
   *
  ...
  public countPaginaVendas(id: any, where: any = {}, customHeaders?: Function): Observable<any> {
    let _method: string = "GET";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/ProdutoAfiliadoHotlinks/:id/paginaVendas/count";
    let _routeParams: any = {
      id: id
    };
    let _postBody: any = {};
  ...
  /**
   * imagemPaginaVendas contagens de ProdutoAfiliadoHotlink.
   *
   * @param {any} id ProdutoAfiliadoHotlink id
   *
   * @param {object} where Criteria to match model instances
   ...
   * </em>
   */
  public AtualizaProdutoHotlink(listaHotlink: any = {}, customHeaders?: Function): Observable<any> {
    let _method: string = "POST";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    ...
    let _postBody: any = {};
    let _urlParams: any = {};
    if (typeof listaHotlink !== 'undefined' && listaHotlink !== null) _urlParams.listaHotlink = listaHotlink;
    let result = this.request(_method, _url, _routeParams, _urlParams, _postBody, null, customHeaders);
    return result;
  }
