...
/**
 * Api services for the `LoadPaginaVenda` model.
 */
@Injectable()
export class LoadPaginaVendaApi extends BaseLoopBackApi {
  ...
  public getPaginaVendaPropria(id: any, refresh: any = {}, customHeaders?: Function): Observable<any> {
    let _method: string = "GET";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/LoadPaginaVendas/:id/paginaVendaPropria";
    let _routeParams: any = {
      id: id
    };
    let _postBody: any = {};
   ...
   * </em>
   */
  public UltimosAcessos(customHeaders?: Function): Observable<any> {
    let _method: string = "GET";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
