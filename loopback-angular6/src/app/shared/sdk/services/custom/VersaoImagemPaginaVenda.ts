...
/**
 * Api services for the `VersaoImagemPaginaVenda` model.
 */
@Injectable()
export class VersaoImagemPaginaVendaApi extends BaseLoopBackApi {
   ...
   *
   * @param {any} id VersaoImagemPaginaVenda id
   *
   ...
   * This usually means the response is a `VersaoImagemPaginaVenda` object.)
   * </em>
   */
  public getVersaoPaginaVenda(id: any, refresh: any = {}, customHeaders?: Function): Observable<any> {
    let _method: string = "GET";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/VersaoImagemPaginaVendas/:id/versaoPaginaVenda";
  ...
  public getDalleSolicitacaoImagem(id: any, refresh: any = {}, customHeaders?: Function): Observable<any> {
    let _method: string = "GET";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/VersaoImagemPaginaVendas/:id/dalleSolicitacaoImagem";
    let _routeParams: any = {
      id: id
    };
    let _postBody: any = {};
  ...
  public AtualizaRelacionamento(item: any = {}, lista: any = {}, customHeaders?: Function): Observable<any> {
    ...
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/VersaoImagemPaginaVendas/atualizaRelacionamento";
    let _routeParams: any = {};
    let _postBody: any = {};
    let _urlParams: any = {};
