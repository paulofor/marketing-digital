...
/**
 * Api services for the `ProdutoAfiliadoGenerico` model.
 */
@Injectable()
export class ProdutoAfiliadoGenericoApi extends BaseLoopBackApi {
  ...
  public getContaGoogle(id: any, refresh: any = {}, customHeaders?: Function): Observable<any> {
    ...
    "/ProdutoAfiliadoGenericos/:id/contaGoogle";
  ...
  public getPlataformaVenda(id: any, refresh: any = {}, customHeaders?: Function): Observable<any> {
    let _method: string = "GET";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/ProdutoAfiliadoGenericos/:id/plataformaVenda";
    let _routeParams: any = {
      id: id
    };
    let _postBody: any = {};
