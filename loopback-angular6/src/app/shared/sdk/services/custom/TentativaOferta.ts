...
/**
 * Api services for the `TentativaOferta` model.
 */
@Injectable()
export class TentativaOfertaApi extends BaseLoopBackApi {
   ...
   *
   * @param {any} id TentativaOferta id
   *
