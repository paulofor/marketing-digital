...
/**
 * Api services for the `PaginaWhatsappGrupo` model.
 */
@Injectable()
export class PaginaWhatsappGrupoApi extends BaseLoopBackApi {
   ...
   *
   * @param {any} id PaginaWhatsappGrupo id
   *
   ...
   * This usually means the response is a `PaginaWhatsappGrupo` object.)
   * </em>
   */
  public getWhatsappGrupo(id: any, refresh: any = {}, customHeaders?: Function): Observable<any> {
    let _method: string = "GET";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/PaginaWhatsappGrupos/:id/whatsappGrupo";
  ...
  public getProdutoProprio(id: any, refresh: any = {}, customHeaders?: Function): Observable<any> {
    let _method: string = "GET";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/PaginaWhatsappGrupos/:id/produtoProprio";
    let _routeParams: any = {
      id: id
    };
    let _postBody: any = {};
  ...
  public findByIdMetaAdsAnuncios(id: any, fk: any, customHeaders?: Function): Observable<any> {
    let _method: string = "GET";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/PaginaWhatsappGrupos/:id/metaAdsAnuncios/:fk";
    let _routeParams: any = {
      id: id,
      fk: fk
    };
  ...
  /**
   * metaAdsAnuncios consultas de PaginaWhatsappGrupo.
   *
   * @param {any} id PaginaWhatsappGrupo id
   *
   * @param {object} filter 
  ...
  public getMetaAdsAnuncios(id: any, filter: LoopBackFilter = {}, customHeaders?: Function): Observable<any> {
    let _method: string = "GET";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/PaginaWhatsappGrupos/:id/metaAdsAnuncios";
    let _routeParams: any = {
      id: id
    };
    let _postBody: any = {};
  ...
  /**
   * metaAdsAnuncios contagens de PaginaWhatsappGrupo.
   *
   * @param {any} id PaginaWhatsappGrupo id
   *
  ...
  public countMetaAdsAnuncios(id: any, where: any = {}, customHeaders?: Function): Observable<any> {
    let _method: string = "GET";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/PaginaWhatsappGrupos/:id/metaAdsAnuncios/count";
    let _routeParams: any = {
      id: id
    };
    let _postBody: any = {};
   ...
   * </em>
   */
  public ListaParaObterImagem(customHeaders?: Function): Observable<any> {
    let _method: string = "GET";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/PaginaWhatsappGrupos/listaParaObterImagem";
    let _routeParams: any = {};
    let _postBody: any = {};
    let _urlParams: any = {};
    let result = this.request(_method, _url, _routeParams, _urlParams, _postBody, null, customHeaders);
  ...
  public AtualizaImagem(pagina: any = {}, customHeaders?: Function): Observable<any> {
    let _method: string = "POST";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/PaginaWhatsappGrupos/atualizaImagem";
    let _routeParams: any = {};
    let _postBody: any = {};
    let _urlParams: any = {};
