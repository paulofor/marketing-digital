...
export class ImagemPaginaVendaApi extends BaseLoopBackApi {
  ...
  public getProdutoAfiliadoHotlink(id: any, refresh: any = {}, customHeaders?: Function): Observable<any> {
    let _method: string = "GET";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/ImagemPaginaVendas/:id/produtoAfiliadoHotlink";
    let _routeParams: any = {
      id: id
    };
    let _postBody: any = {};
  ...
  public getProdutoProprio(id: any, refresh: any = {}, customHeaders?: Function): Observable<any> {
    let _method: string = "GET";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/ImagemPaginaVendas/:id/produtoProprio";
    let _routeParams: any = {
      id: id
    };
    let _postBody: any = {};
  ...
  public findByIdPaginaVendaProprias(id: any, fk: any, customHeaders?: Function): Observable<any> {
    let _method: string = "GET";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/ImagemPaginaVendas/:id/paginaVendaProprias/:fk";
    let _routeParams: any = {
      id: id,
      fk: fk
    };
  ...
  /**
   * paginaVendaProprias consultas de ImagemPaginaVenda.
   *
   * @param {any} id ImagemPaginaVenda id
   *
   * @param {object} filter 
  ...
  public getPaginaVendaProprias(id: any, filter: LoopBackFilter = {}, customHeaders?: Function): Observable<any> {
    let _method: string = "GET";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/ImagemPaginaVendas/:id/paginaVendaProprias";
    let _routeParams: any = {
      id: id
    };
    let _postBody: any = {};
  ...
  /**
   * paginaVendaProprias contagens de ImagemPaginaVenda.
   *
   * @param {any} id ImagemPaginaVenda id
   *
   * @param {object} where Criteria to match model instances
  ...
  public countPaginaVendaProprias(id: any, where: any = {}, customHeaders?: Function): Observable<any> {
    let _method: string = "GET";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/ImagemPaginaVendas/:id/paginaVendaProprias/count";
    let _routeParams: any = {
      id: id
    };
    let _postBody: any = {};
   ...
   * </em>
   */
  public RegistraImagem(imagens: any = {}, customHeaders?: Function): Observable<any> {
    let _method: string = "POST";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/ImagemPaginaVendas/registraImagem";
    let _routeParams: any = {};
    let _postBody: any = {};
    let _urlParams: any = {};
    if (typeof imagens !== 'undefined' && imagens !== null) _urlParams.imagens = imagens;
    let result = this.request(_method, _url, _routeParams, _urlParams, _postBody, null, customHeaders);
    return result;
  }
   ...
   * </em>
   */
  public AlteraDisponivel(idImagem: any = {}, customHeaders?: Function): Observable<any> {
    let _method: string = "POST";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/ImagemPaginaVendas/alteraDisponivel";
    let _routeParams: any = {};
    let _postBody: any = {};
    let _urlParams: any = {};
    if (typeof idImagem !== 'undefined' && idImagem !== null) _urlParams.idImagem = idImagem;
    let result = this.request(_method, _url, _routeParams, _urlParams, _postBody, null, customHeaders);
    return result;
  }
   ...
   * </em>
   */
  public ListaParaJpg(customHeaders?: Function): Observable<any> {
    let _method: string = "GET";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/ImagemPaginaVendas/listaParaJpg";
    let _routeParams: any = {};
    let _postBody: any = {};
    let _urlParams: any = {};
    let result = this.request(_method, _url, _routeParams, _urlParams, _postBody, null, customHeaders);
   ...
   * </em>
   */
  public RegistraJpg(imagem: any = {}, customHeaders?: Function): Observable<any> {
    let _method: string = "POST";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/ImagemPaginaVendas/registraJpg";
    let _routeParams: any = {};
    let _postBody: any = {};
    let _urlParams: any = {};
