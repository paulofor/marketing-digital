...
/**
 * Api services for the `EntregavelProduto` model.
 */
@Injectable()
export class EntregavelProdutoApi extends BaseLoopBackApi {
  ...
  public getProdutoProprio(id: any, refresh: any = {}, customHeaders?: Function): Observable<any> {
    ...
    "/EntregavelProdutos/:id/produtoProprio";
  ...
  public findByIdConteudoProdutoKiwifys(id: any, fk: any, customHeaders?: Function): Observable<any> {
    let _method: string = "GET";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/EntregavelProdutos/:id/conteudoProdutoKiwifys/:fk";
    let _routeParams: any = {
      id: id,
      fk: fk
    };
  ...
  /**
   * Localize um item relacionado por ID para promptImagemConteudos.
   *
   * @param {any} id EntregavelProduto id
   *
   * @param {any} fk Chave estrangeira para promptImagemConteudos
   *
   * @returns {object} An empty reference that will be
   *   populated with the actual data once the response is returned
   *   from the server.
   ...
   * </em>
   */
  public findByIdPromptImagemConteudos(id: any, fk: any, customHeaders?: Function): Observable<any> {
    let _method: string = "GET";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
  ...
  /**
   * Excluir um item relacionado por ID para promptImagemConteudos.
   *
   * @param {any} id EntregavelProduto id
   *
   * @param {any} fk Chave estrangeira para promptImagemConteudos
   ...
   * This method returns no data.
   */
  public destroyByIdPromptImagemConteudos(id: any, fk: any, customHeaders?: Function): Observable<any> {
    let _method: string = "DELETE";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/EntregavelProdutos/:id/promptImagemConteudos/:fk";
    let _routeParams: any = {
  ...
  /**
   * Atualizar um item relacionado por ID para promptImagemConteudos.
   *
   * @param {any} id EntregavelProduto id
   *
   * @param {any} fk Chave estrangeira para promptImagemConteudos
   ...
   * </em>
   */
  public updateByIdPromptImagemConteudos(id: any, fk: any, data: any = {}, customHeaders?: Function): Observable<any> {
    let _method: string = "PUT";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/EntregavelProdutos/:id/promptImagemConteudos/:fk";
    let _routeParams: any = {
  ...
  /**
   * conteudoProdutoKiwifys consultas de EntregavelProduto.
   *
   * @param {any} id EntregavelProduto id
   *
   * @param {object} filter 
  ...
  public getConteudoProdutoKiwifys(id: any, filter: LoopBackFilter = {}, customHeaders?: Function): Observable<any> {
    let _method: string = "GET";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/EntregavelProdutos/:id/conteudoProdutoKiwifys";
    let _routeParams: any = {
      id: id
    };
    let _postBody: any = {};
  ...
  /**
   * conteudoProdutoKiwifys contagens de EntregavelProduto.
   *
   * @param {any} id EntregavelProduto id
   *
  ...
  public countConteudoProdutoKiwifys(id: any, where: any = {}, customHeaders?: Function): Observable<any> {
    let _method: string = "GET";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/EntregavelProdutos/:id/conteudoProdutoKiwifys/count";
    let _routeParams: any = {
      id: id
    };
    let _postBody: any = {};
  ...
  /**
   * promptImagemConteudos consultas de EntregavelProduto.
   *
   * @param {any} id EntregavelProduto id
   *
   * @param {object} filter 
   ...
   * </em>
   */
  public getPromptImagemConteudos(id: any, filter: LoopBackFilter = {}, customHeaders?: Function): Observable<any> {
    let _method: string = "GET";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
  ...
  /**
   * Cria uma nova instância no promptImagemConteudos deste modelo.
   *
   * @param {any} id EntregavelProduto id
   *
   * @param {object} data Request data.
   ...
   * </em>
   */
  public createPromptImagemConteudos(id: any, data: any = {}, customHeaders?: Function): Observable<any> {
    let _method: string = "POST";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/EntregavelProdutos/:id/promptImagemConteudos";
    let _routeParams: any = {
  ...
  /**
   * Exclui todos os promptImagemConteudos deste modelo.
   *
   * @param {any} id EntregavelProduto id
   *
   * @returns {object} An empty reference that will be
   ...
   * This method returns no data.
   */
  public deletePromptImagemConteudos(id: any, customHeaders?: Function): Observable<any> {
    let _method: string = "DELETE";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/EntregavelProdutos/:id/promptImagemConteudos";
    let _routeParams: any = {
  ...
  /**
   * promptImagemConteudos contagens de EntregavelProduto.
   *
   * @param {any} id EntregavelProduto id
   *
   * @param {object} where Criteria to match model instances
   ...
   *  - `count` – `{number}` - 
   */
  public countPromptImagemConteudos(id: any, where: any = {}, customHeaders?: Function): Observable<any> {
    let _method: string = "GET";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/EntregavelProdutos/:id/promptImagemConteudos/count";
    let _routeParams: any = {
      id: id
    };
    let _postBody: any = {};
   ...
   * </em>
   */
  public ListaParaGerarImagemConteudo(customHeaders?: Function): Observable<any> {
    let _method: string = "GET";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/EntregavelProdutos/listaParaGerarImagemConteudo";
    let _routeParams: any = {};
    let _postBody: any = {};
    let _urlParams: any = {};
    let result = this.request(_method, _url, _routeParams, _urlParams, _postBody, null, customHeaders);
   ...
   * </em>
   */
  public ListaParaGerarEbook(customHeaders?: Function): Observable<any> {
    let _method: string = "GET";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/EntregavelProdutos/listaParaGerarEbook";
    let _routeParams: any = {};
    let _postBody: any = {};
    let _urlParams: any = {};
    let result = this.request(_method, _url, _routeParams, _urlParams, _postBody, null, customHeaders);
   ...
   * </em>
   */
  public createManyPromptImagemConteudos(id: any, data: any[] = [], customHeaders?: Function): Observable<any> {
    let _method: string = "POST";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/EntregavelProdutos/:id/promptImagemConteudos";
    let _routeParams: any = {
