 ...
 */
@Injectable()
export class IdeiaPalavraChaveApi extends BaseLoopBackApi {
   ...
   * </em>
   */
  public AtualizaMaisRecentePalavraChave(customHeaders?: Function): Observable<any> {
    let _method: string = "POST";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
  ...
  public MelhoresUltimaData(limiteMensal: any = {}, customHeaders?: Function): Observable<any> {
    ...
    let _postBody: any = {};
    let _urlParams: any = {};
    if (typeof limiteMensal !== 'undefined' && limiteMensal !== null) _urlParams.limiteMensal = limiteMensal;
    let result = this.request(_method, _url, _routeParams, _urlParams, _postBody, null, customHeaders);
    return result;
  }
   ...
   * </em>
   */
  public RecebeLista(listaPalavra: any = {}, hotmartId: any = {}, customHeaders?: Function): Observable<any> {
    let _method: string = "POST";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    ...
    let _postBody: any = {};
    let _urlParams: any = {};
    if (typeof listaPalavra !== 'undefined' && listaPalavra !== null) _urlParams.listaPalavra = listaPalavra;
   ...
   * </em>
   */
  public MelhoresCpcComVisita(limite: any = {}, customHeaders?: Function): Observable<any> {
    let _method: string = "GET";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    ...
    let _postBody: any = {};
    let _urlParams: any = {};
    if (typeof limite !== 'undefined' && limite !== null) _urlParams.limite = limite;
    let result = this.request(_method, _url, _routeParams, _urlParams, _postBody, null, customHeaders);
    return result;
  }
   ...
   * </em>
   */
  public CalculaCpcAlvo(customHeaders?: Function): Observable<any> {
    let _method: string = "POST";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
   ...
   * </em>
   */
  public AtualizaQuantidadeVisita(customHeaders?: Function): Observable<any> {
    let _method: string = "POST";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
   ...
   * </em>
   */
  public ListaTop(customHeaders?: Function): Observable<any> {
    let _method: string = "GET";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
   ...
   * </em>
   */
  public ListaTopPesquisa(customHeaders?: Function): Observable<any> {
    let _method: string = "GET";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
   ...
   * </em>
   */
  public AtualizaMaisRecentePorProduto(hotmartId: any = {}, customHeaders?: Function): Observable<any> {
    let _method: string = "POST";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/IdeiaPalavraChaves/atualizaMaisRecentePorProduto";
    let _routeParams: any = {};
    let _postBody: any = {};
    let _urlParams: any = {};
    if (typeof hotmartId !== 'undefined' && hotmartId !== null) _urlParams.hotmartId = hotmartId;
