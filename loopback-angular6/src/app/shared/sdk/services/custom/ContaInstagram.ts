...
/**
 * Api services for the `ContaInstagram` model.
 */
@Injectable()
export class ContaInstagramApi extends BaseLoopBackApi {
   ...
   *
   * @param {any} id ContaInstagram id
   *
  ...
  /**
   * metaAdsAnuncios consultas de ContaInstagram.
   *
   * @param {any} id ContaInstagram id
   *
   * @param {object} filter 
  ...
  public getMetaAdsAnuncios(id: any, filter: LoopBackFilter = {}, customHeaders?: Function): Observable<any> {
    let _method: string = "GET";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/ContaInstagrams/:id/metaAdsAnuncios";
    let _routeParams: any = {
      id: id
    };
    let _postBody: any = {};
  ...
  /**
   * metaAdsAnuncios contagens de ContaInstagram.
   *
   * @param {any} id ContaInstagram id
   *
  ...
  public countMetaAdsAnuncios(id: any, where: any = {}, customHeaders?: Function): Observable<any> {
    let _method: string = "GET";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/ContaInstagrams/:id/metaAdsAnuncios/count";
    let _routeParams: any = {
      id: id
    };
    let _postBody: any = {};
