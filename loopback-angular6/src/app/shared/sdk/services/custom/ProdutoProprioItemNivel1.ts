...
/**
 * Api services for the `ProdutoProprioItemNivel1` model.
 */
@Injectable()
export class ProdutoProprioItemNivel1Api extends BaseLoopBackApi {
  ...
  /**
   * Busca relação produtoProprioVersao de belongsTo.
   *
   * @param {any} id ProdutoProprioItemNivel1 id
   *
   ...
   * </em>
   */
  public getProdutoProprioVersao(id: any, refresh: any = {}, customHeaders?: Function): Observable<any> {
    let _method: string = "GET";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/ProdutoProprioItemNivel1s/:id/produtoProprioVersao";
  ...
  public obtemListaVersaoCorrente(idProdutoProprio: any = {}, customHeaders?: Function): Observable<any> {
    ...
    let _postBody: any = {};
    let _urlParams: any = {};
    if (typeof idProdutoProprio !== 'undefined' && idProdutoProprio !== null) _urlParams.idProdutoProprio = idProdutoProprio;
    let result = this.request(_method, _url, _routeParams, _urlParams, _postBody, null, customHeaders);
    return result;
  }
