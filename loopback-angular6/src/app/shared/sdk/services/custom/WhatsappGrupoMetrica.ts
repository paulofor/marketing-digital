...
/**
 * Api services for the `WhatsappGrupoMetrica` model.
 */
@Injectable()
export class WhatsappGrupoMetricaApi extends BaseLoopBackApi {
   ...
   *
   * @param {any} id WhatsappGrupoMetrica id
   *
   ...
   * This usually means the response is a `WhatsappGrupoMetrica` object.)
   * </em>
   */
  public getWhatsappGrupo(id: any, refresh: any = {}, customHeaders?: Function): Observable<any> {
    let _method: string = "GET";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/WhatsappGrupoMetricas/:id/whatsappGrupo";
