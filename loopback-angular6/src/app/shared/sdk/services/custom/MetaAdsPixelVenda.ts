...
/**
 * Api services for the `MetaAdsPixelVenda` model.
 */
@Injectable()
export class MetaAdsPixelVendaApi extends BaseLoopBackApi {
   ...
   *
   * @param {any} id MetaAdsPixelVenda id
   *
  ...
  public getProdutoAfiliadoHotmart(id: any, refresh: any = {}, customHeaders?: Function): Observable<any> {
    let _method: string = "GET";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/MetaAdsPixelVendas/:id/produtoAfiliadoHotmart";
    let _routeParams: any = {
      id: id
    };
    let _postBody: any = {};
