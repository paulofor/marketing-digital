...
/**
 * Api services for the `ScrollPaginaVendaPropria` model.
 */
@Injectable()
export class ScrollPaginaVendaPropriaApi extends BaseLoopBackApi {
   ...
   *
   * @param {any} id ScrollPaginaVendaPropria id
   *
  ...
  public getPaginaVendaPropria(id: any, refresh: any = {}, customHeaders?: Function): Observable<any> {
    ...
    "/ScrollPaginaVendaPropria/:id/paginaVendaPropria";
