...
/**
 * Api services for the `MetaAdsConjuntoAnuncio` model.
 */
@Injectable()
export class MetaAdsConjuntoAnuncioApi extends BaseLoopBackApi {
  ...
  /**
   * Busca relação metaAdsCampanha de belongsTo.
   *
   ...
   * </em>
   */
  public getMetaAdsCampanha(id: any, refresh: any = {}, customHeaders?: Function): Observable<any> {
    let _method: string = "GET";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/MetaAdsConjuntoAnuncios/:id/metaAdsCampanha";
  ...
  public findByIdMetaAdsAnuncios(id: any, fk: any, customHeaders?: Function): Observable<any> {
    let _method: string = "GET";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/MetaAdsConjuntoAnuncios/:id/metaAdsAnuncios/:fk";
    let _routeParams: any = {
      id: id,
      fk: fk
    };
  ...
  /**
   * metaAdsAnuncios consultas de MetaAdsConjuntoAnuncio.
   *
   * @param {any} id MetaAdsConjuntoAnuncio id
   *
   * @param {object} filter 
  ...
  public getMetaAdsAnuncios(id: any, filter: LoopBackFilter = {}, customHeaders?: Function): Observable<any> {
    let _method: string = "GET";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/MetaAdsConjuntoAnuncios/:id/metaAdsAnuncios";
    let _routeParams: any = {
      id: id
    };
    let _postBody: any = {};
  ...
  /**
   * metaAdsAnuncios contagens de MetaAdsConjuntoAnuncio.
   *
   * @param {any} id MetaAdsConjuntoAnuncio id
   *
  ...
  public countMetaAdsAnuncios(id: any, where: any = {}, customHeaders?: Function): Observable<any> {
    let _method: string = "GET";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/MetaAdsConjuntoAnuncios/:id/metaAdsAnuncios/count";
    let _routeParams: any = {
      id: id
    };
    let _postBody: any = {};
