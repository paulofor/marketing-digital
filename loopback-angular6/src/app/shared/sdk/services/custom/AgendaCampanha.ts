...
/**
 * Api services for the `AgendaCampanha` model.
 */
@Injectable()
export class AgendaCampanhaApi extends BaseLoopBackApi {
   ...
   *
   * @param {any} id AgendaCampanha id
   *
