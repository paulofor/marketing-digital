...
/**
 * Api services for the `SolicitacaoCheckout` model.
 */
@Injectable()
export class SolicitacaoCheckoutApi extends BaseLoopBackApi {
   ...
   *
   * @param {any} id SolicitacaoCheckout id
   *
  ...
  public getProdutoAfiliadoHotmart(id: any, refresh: any = {}, customHeaders?: Function): Observable<any> {
    ...
    "/SolicitacaoCheckouts/:id/produtoAfiliadoHotmart";
   ...
   * </em>
   */
  public InsereItem(idHm: any = {}, visitante: any = {}, url: any = {}, customHeaders?: Function): Observable<any> {
    let _method: string = "GET";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
