...
/**
 * Api services for the `WhatsappMensagem` model.
 */
@Injectable()
export class WhatsappMensagemApi extends BaseLoopBackApi {
   ...
   *
   * @param {any} id WhatsappMensagem id
   *
