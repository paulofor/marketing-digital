...
/**
 * Api services for the `CriativoAnuncio` model.
 */
@Injectable()
export class CriativoAnuncioApi extends BaseLoopBackApi {
   ...
   *
   * @param {any} id CriativoAnuncio id
   *
  ...
  public getProdutoProprio(id: any, refresh: any = {}, customHeaders?: Function): Observable<any> {
    let _method: string = "GET";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/CriativoAnuncios/:id/produtoProprio";
    let _routeParams: any = {
      id: id
    };
    let _postBody: any = {};
  ...
  public findByIdMetaAdsAnuncios(id: any, fk: any, customHeaders?: Function): Observable<any> {
    let _method: string = "GET";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/CriativoAnuncios/:id/metaAdsAnuncios/:fk";
    let _routeParams: any = {
      id: id,
      fk: fk
    };
  ...
  public getFonteLocal(id: any, refresh: any = {}, customHeaders?: Function): Observable<any> {
    let _method: string = "GET";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/CriativoAnuncios/:id/fonteLocal";
    let _routeParams: any = {
      id: id
    };
    let _postBody: any = {};
  ...
  /**
   * metaAdsAnuncios consultas de CriativoAnuncio.
   *
   * @param {any} id CriativoAnuncio id
   *
   * @param {object} filter 
  ...
  public getMetaAdsAnuncios(id: any, filter: LoopBackFilter = {}, customHeaders?: Function): Observable<any> {
    let _method: string = "GET";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/CriativoAnuncios/:id/metaAdsAnuncios";
    let _routeParams: any = {
      id: id
    };
    let _postBody: any = {};
  ...
  /**
   * metaAdsAnuncios contagens de CriativoAnuncio.
   *
   * @param {any} id CriativoAnuncio id
   *
  ...
  public countMetaAdsAnuncios(id: any, where: any = {}, customHeaders?: Function): Observable<any> {
    let _method: string = "GET";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/CriativoAnuncios/:id/metaAdsAnuncios/count";
    let _routeParams: any = {
      id: id
    };
    let _postBody: any = {};
  ...
  public ListaParaGerarImagem(customHeaders?: Function): Observable<any> {
    let _method: string = "GET";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/CriativoAnuncios/listaParaGerarImagem";
    let _routeParams: any = {};
    let _postBody: any = {};
    let _urlParams: any = {};
    let result = this.request(_method, _url, _routeParams, _urlParams, _postBody, null, customHeaders);
   ...
   * </em>
   */
  public AtualizaImagemEditada(criativo: any = {}, customHeaders?: Function): Observable<any> {
    let _method: string = "POST";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/CriativoAnuncios/atualizaImagemEditada";
    let _routeParams: any = {};
    let _postBody: any = {};
    let _urlParams: any = {};
    if (typeof criativo !== 'undefined' && criativo !== null) _urlParams.criativo = criativo;
    let result = this.request(_method, _url, _routeParams, _urlParams, _postBody, null, customHeaders);
    return result;
  }
