 ...
 */
@Injectable()
export class CampanhaAdsMetricaIntradayApi extends BaseLoopBackApi {
   ...
   * </em>
   */
  public AtualizaIntraday(metricaIntraday: any = {}, customHeaders?: Function): Observable<any> {
    ...
    let _postBody: any = {};
    let _urlParams: any = {};
    if (typeof metricaIntraday !== 'undefined' && metricaIntraday !== null) _urlParams.metricaIntraday = metricaIntraday;
    let result = this.request(_method, _url, _routeParams, _urlParams, _postBody, null, customHeaders);
    return result;
  }
   ...
   * </em>
   */
  public DesligarTodos(customHeaders?: Function): Observable<any> {
    let _method: string = "POST";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
   ...
   * </em>
   */
  public TotaisDia(customHeaders?: Function): Observable<any> {
    let _method: string = "GET";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
   ...
   * </em>
   */
  public LimpaDia(customHeaders?: Function): Observable<any> {
    let _method: string = "POST";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
   ...
   * </em>
   */
  public ListaHistorico(codigoAds: any = {}, limite: any = {}, customHeaders?: Function): Observable<any> {
    let _method: string = "GET";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/CampanhaAdsMetricaIntradays/listaHistorico";
    let _routeParams: any = {};
    let _postBody: any = {};
    let _urlParams: any = {};
    if (typeof codigoAds !== 'undefined' && codigoAds !== null) _urlParams.codigoAds = codigoAds;
   ...
   * </em>
   */
  public MelhoresCtrHistorico(customHeaders?: Function): Observable<any> {
    let _method: string = "GET";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/CampanhaAdsMetricaIntradays/melhoresCtrHistorico";
    let _routeParams: any = {};
    let _postBody: any = {};
    let _urlParams: any = {};
    let result = this.request(_method, _url, _routeParams, _urlParams, _postBody, null, customHeaders);
