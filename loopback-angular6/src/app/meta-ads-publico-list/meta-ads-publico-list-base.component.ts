...
export class MetaAdsPublicoListBaseComponent implements OnInit {
	principal: MetaAdsPublico;
	listaBase:MetaAdsPublico[]
	idPrincipal: number;
	constructor(protected srv: MetaAdsPublicoApi, protected router: ActivatedRoute, protected dialog: MatDialog) { }
    ...
    carregaTela() {
        this.srv.find(this.getFiltro())
	     .subscribe((result:MetaAdsPublico[]) => {
