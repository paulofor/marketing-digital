...
export class PublicoAlvoAdsPalavraProdutoProprioListBaseComponent implements OnInit {
	principal: PublicoAlvoAdsPalavra;
	listaBase:PublicoAlvoAdsPalavra[]
	idPrincipal: number;
	...
	getComponente() : any {
		return PublicoAlvoAdsPalavraEditComponent
	}
