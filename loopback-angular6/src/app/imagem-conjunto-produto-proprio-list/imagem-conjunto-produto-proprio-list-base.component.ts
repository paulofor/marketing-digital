...
export class ImagemConjuntoProdutoProprioListBaseComponent implements OnInit {
	principal: ImagemConjunto;
	listaBase:ImagemConjunto[]
	idPrincipal: number;
	...
	getComponente() : any {
		return ImagemConjuntoEditComponent
	}
