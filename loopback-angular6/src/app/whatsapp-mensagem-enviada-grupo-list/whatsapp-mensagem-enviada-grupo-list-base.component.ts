...
import { WhatsappMensagemEnviadaGrupo , WhatsappMensagemEnviadaGrupoApi } from "../shared/sdk";
...
export class WhatsappMensagemEnviadaGrupoListBaseComponent implements OnInit {
	principal: WhatsappMensagemEnviadaGrupo;
	listaBase:WhatsappMensagemEnviadaGrupo[]
	idPrincipal: number;
