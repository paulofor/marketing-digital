...
export class PaginaWhatsappGrupoListBaseComponent implements OnInit {
	principal: PaginaWhatsappGrupo;
	listaBase:PaginaWhatsappGrupo[]
	idPrincipal: number;
	...
	getComponente() : any {
		return PaginaWhatsappGrupoEditComponent
	}
