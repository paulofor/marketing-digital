...
export class PlataformaVendaListBaseComponent implements OnInit {
	principal: PlataformaVenda;
	listaBase:PlataformaVenda[]
	idPrincipal: number;
    ...
    carregaTela() {
        this.srv.find(this.getFiltro())
	     .subscribe((result:PlataformaVenda[]) => {
	...
	getComponente() : any {
		return PlataformaVendaEditComponent
	}
