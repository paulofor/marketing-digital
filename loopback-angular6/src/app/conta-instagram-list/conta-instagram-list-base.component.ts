...
import { ContaInstagram , ContaInstagramApi } from "../shared/sdk";
import { ContaInstagramEditComponent } from "../conta-instagram-edit/conta-instagram-edit.component";

export class ContaInstagramListBaseComponent implements OnInit {
	principal: ContaInstagram;
	listaBase:ContaInstagram[]
	idPrincipal: number;
    ...
    carregaTela() {
        this.srv.find(this.getFiltro())
	     .subscribe((result:ContaInstagram[]) => {
	...
	getComponente() : any {
		return ContaInstagramEditComponent
	}
