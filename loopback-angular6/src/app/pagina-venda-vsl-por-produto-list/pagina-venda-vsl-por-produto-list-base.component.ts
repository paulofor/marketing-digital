...
export class PaginaVendaVslPorProdutoListBaseComponent implements OnInit {
	principal: PaginaVendaVsl;
	listaBase:PaginaVendaVsl[]
	idPrincipal: number;
	...
	getComponente() : any {
		return PaginaVendaVslEditComponent
	}
