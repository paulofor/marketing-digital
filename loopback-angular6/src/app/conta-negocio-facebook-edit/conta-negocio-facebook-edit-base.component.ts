...
import { ContaNegocioFacebook, ContaNegocioFacebookApi } from "../shared/sdk";

export class ContaNegocioFacebookEditBaseComponent implements OnInit{

	itemPre: any;
	item: ContaNegocioFacebook;
	origem: any;
	...
	criaItem() {
   		return new ContaNegocioFacebook();
	}
	montaCombos() {
	}
	posItem() {
