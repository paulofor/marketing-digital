...
export class EstruturaPaginaVendaAbertaListBaseComponent implements OnInit {
	principal: EstruturaPaginaVendaAberta;
	listaBase:EstruturaPaginaVendaAberta[]
	idPrincipal: number;
	...
	getComponente() : any {
		return EstruturaPaginaVendaAbertaEditComponent
	}
