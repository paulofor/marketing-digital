...
export class CriativoAnuncioEditBaseComponent implements OnInit{

	itemPre: any;
	item: CriativoAnuncio;
	origem: any;

    constructor(protected dialogRef: MatDialogRef<any>
        , @Inject(MAT_DIALOG_DATA) protected data: any, protected servico: CriativoAnuncioApi,
      ) {
    }
