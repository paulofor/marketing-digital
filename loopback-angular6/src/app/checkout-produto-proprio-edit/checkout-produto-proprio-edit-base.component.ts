...
import { CheckoutProdutoProprio, CheckoutProdutoProprioApi } from "../shared/sdk";

export class CheckoutProdutoProprioEditBaseComponent implements OnInit{

	itemPre: any;
	item: CheckoutProdutoProprio;
	origem: any;
	...
	criaItem() {
   		return new CheckoutProdutoProprio();
	}
	montaCombos() {
	}
	posItem() {
