...
export class PaginaVendaAbertaEditBaseComponent implements OnInit{

	itemPre: any;
	item: PaginaVendaAberta;
	origem: any;

    constructor(protected dialogRef: MatDialogRef<any>
        , @Inject(MAT_DIALOG_DATA) protected data: any, protected servico: PaginaVendaAbertaApi,
      ) {
    }
