...
import { ScriptGeraVideo, ScriptGeraVideoApi } from "../shared/sdk";

export class ScriptGeraVideoEditBaseComponent implements OnInit{

	itemPre: any;
	item: ScriptGeraVideo;
	origem: any;
