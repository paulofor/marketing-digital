...
export class CheckoutProdutoProprioListBaseComponent implements OnInit {
	principal: CheckoutProdutoProprio;
	listaBase:CheckoutProdutoProprio[]
	idPrincipal: number;
	...
	getComponente() : any {
		return CheckoutProdutoProprioEditComponent
	}
