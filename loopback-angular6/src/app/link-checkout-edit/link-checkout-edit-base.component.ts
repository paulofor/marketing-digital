...
import { LinkCheckout, LinkCheckoutApi } from "../shared/sdk";

export class LinkCheckoutEditBaseComponent implements OnInit{
    ...
    constructor(protected dialogRef: MatDialogRef<any>
        , @Inject(MAT_DIALOG_DATA) protected data: any, protected servico: LinkCheckoutApi,
      ) {
    }
